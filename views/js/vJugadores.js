			   ...
			   <h1 class="teamName">`+result[equipo].nombre+`</h1>
				<div class="row">
					...
					for (let jugador = 0; jugador < result[equipo].listJugadores.length; jugador++) {
						...
						<img src="http://tres.fpz1920.com/uploads/`+result[equipo].listJugadores[jugador].objUser.pic+`" class="card-img-top imgJugador" alt="...">
						<div class="card-body">
					...
					for (let entrenador = 0; entrenador < result[equipo].listEntrenadores.length; entrenador++) {
						...
						<img src="http://tres.fpz1920.com/uploads/`+result[equipo].listEntrenadores[entrenador].objUser.pic+`" class="card-img-top imgTecnico" alt="..." >
						<div class="card-body">
					...
					for (let cuerpo = 0; cuerpo < result[equipo].listCuerpo.length; cuerpo++) {
						...
						<img src="http://tres.fpz1920.com/uploads/`+result[equipo].listCuerpo[cuerpo].objUser.pic+`" class="card-img-top imgTecnico" alt="..." >
						<div class="card-body">
